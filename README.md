...
KeenKeeper is a modern web application designed to help you nurture and manage your most meaningful connections. Built with a focus on clean aesthetics and user experience, it allows you to keep track of your interactions and stay close to the people who matter most.
...
* **Lucide React / React Icons** - For clean and consistent iconography.
* **React Router** - For seamless navigation between pages.
* **Local Storage** - For persistent data management without a backend.
